...
part of 'reader_screen_state.dart';
...
mixin _$ReaderScreenState {
  int get stateScreen => throw _privateConstructorUsedError;

  /// Create a copy of ReaderScreenState
...
class _$ReaderScreenStateCopyWithImpl<$Res, $Val extends ReaderScreenState>
  ...
  @override
  $Res call({
    Object? stateScreen = null,
  }) {
    return _then(_value.copyWith(
      stateScreen: null == stateScreen
          ? _value.stateScreen
          : stateScreen // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
class _$ReaderScreenStateImpl implements _ReaderScreenState {
  const _$ReaderScreenStateImpl({this.stateScreen = 0});

  @override
  @JsonKey()
  final int stateScreen;

  @override
  String toString() {
    return 'ReaderScreenState(stateScreen: $stateScreen)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.stateScreen, stateScreen) ||
                other.stateScreen == stateScreen));
  }

  @override
  int get hashCode => Object.hash(runtimeType, stateScreen);
...
abstract class _ReaderScreenState implements ReaderScreenState {
  const factory _ReaderScreenState({final int stateScreen}) =
